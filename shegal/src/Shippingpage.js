...
//       await axios.post("http://127.0.0.1:8000/store/ship/",formData, { headers: { Authorization: `Bearer ${token}`} });
...
//           <input type="text" placeholder="Ward no." name="ward" value={formData.ward} onChange={handleChange} required/>
//         </div>
...
//       <button className="back-btn" onClick={gotocart}>← Back To Cart</button>
